...
class GenerateSPFRecordTests(BaseTest):
    ...
    def test_generate_spf_record_with_all_fields_with_valid_data(self):
        ...
        # Assertion
        from testData_.data import successStatus, spfRecordVersion, spfRecordType, softFailValue
    ...
    def test_generate_spf_record_with_invalid_data(self):
        ...
        # Assertion
        from testData_.data import failStatus
        spfRecordStatus = self.spfRecordGeneratorObj.get_generated_spf_record_status()
        self.assertEqual(spfRecordStatus, failStatus, f"Error: Expected status must be '{failStatus}', but bot '{spfRecordStatus}'")
